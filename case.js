...
Status: ${isPrem ? 'Premium' : 'Free'}`);
      ...
      case 'viewonce': {
        ...
        try {
          ...
          const mime = (quoted.msg || quoted).mimetype || '';
          if (/image/.test(mime)) {
            await jamesdev.sendMessage(from, { image: buffer, caption: (quoted.msg || quoted).caption || 'Downloaded by Killua MD' }, { quoted: m });
          } else if (/video/.test(mime)) {
            await jamesdev.sendMessage(from, { video: buffer, caption: (quoted.msg || quoted).caption || 'Downloaded by Killua MD' }, { quoted: m });
          }
        } catch (e) {
